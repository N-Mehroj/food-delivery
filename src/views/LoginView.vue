<template>
  <div class="login grid gap-0 md:grid-cols-2 xl:grid-cols-12">
    <div class="container pt-6 2xl:pl-40 xl:pl-40 lg:pl-20 md:px-10 xl:col-span-5 h-screen">
      ...
      <div class="login-cot mt-16 md:mt-40 xl:mt-32 xl:pr-12 2xl:mt-20">
        ...
        <form @submit.prevent class="mt-6">
          <label>Email</label>
          <Input placeholder="name@example.com" type="email" :value="email" @input="email = $event.target.value" />
        ...
        <div
          ...
          Forgot password ?
          <RouterLink :to="{ name: 'register' }" href="#" class="text-[#4E60FF]">Sign Up
          </RouterLink>
        </div>
      </div>
    </div>
