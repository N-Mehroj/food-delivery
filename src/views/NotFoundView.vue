<template>
        <div class="main">
            ...
            <div class="top-nav flex justify-center mt-10 mb-20">
                  <div>
                    <RouterLink :to="{name: 'home'}" class="text-[#4E60FF] px-5 py-4 rounded-md bg-white border transition-colors border-[#4E60FF] cursor-pointer" style="align-items: center;">Back Home Page</RouterLink>
                  </div>
            </div>
        </div>
