<template>
  ...
  >
    ...
    <div class="mt-4 md:pl-10 xl:col-span-7 xl:mr-10 xl:ml-16 2xl:pr-15">
        ...
        <div class="step inline-blocks flex mt-6">
          ...
          >
            <v-icon
              ...
              :class="[{ 'opacity-0': step == 1 }, { 'opacity-1': step > 1 }]"
            ></v-icon>
          </div>
          <div
            :class="[
          ...
          >
            <v-icon
              name="bi-check"
              class="mb-1 text-white"
              :class="[{ 'opacity-0': step <= 2 }, { 'opacity-1': step > 2 }]"
            ></v-icon>
          </div>
          <div
            :class="[
          ...
          >
            <v-icon
              name="bi-check"
              class="mb-1 text-white"
              :class="[{ 'opacity-0': step <= 3 }, { 'opacity-1': step > 3 }]"
            ></v-icon>
          </div>
          <div
            :class="[
          ...
          >
            <v-icon
              name="bi-check"
              class="mb-1 text-white"
              :class="[{ 'opacity-0': step <= 4 }, { 'opacity-1': step > 4 }]"
            ></v-icon>
          </div>
        </div>
      ...
      <div class="box-const">
        <div
          class="xl:mt-28 mt-10 md:mt-11 2xl:pr-48 md:pr-10 bloc"
          ...
          <div class="flex flex-wrap md:mt-6 justify-between 2xl:max-w-xl">
            ...
            >
              <div class="inline-block mt-1 transition-all">
                <div
                  class="bg-[#EDEEF2] inline-block p-3 rounded-xl"
                  :class="[{ 'bg-bl ': typeName }]"
                >
                  <v-icon
                    name="oi-person"
                    :class="[{ 'text-[#fff]': typeName }]"
                    class="text-[#A1A2B4]"
                    scale="1.3"
                  />
                </div>
...
export default {
  ...
  methods: {
    ...
    onSubmitPhone(number) {
      ...
      this.$store.dispatch('phone', phone).then((phone) => {
